...
const CreateAuthorModal = ({ open, setOpen, fetch }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            fetch();
            toast.success("L'auteur "+author.lastname + " "+author.firstname + " à bien été ajouté")
            handleClose();
        } catch (error) {
    ...
    >
        <Box sx={style}>
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <Button type='submit' className='darkorange col-12'>Ajouter</Button>
            </Form>
        </Box>
    </Modal>
        ;
