...
CREATE TABLE Users(id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, login varchar(255) NOT NULL,password VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL DEFAULT 'USER');
